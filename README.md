...
- 🔬 **科学新闻（10 个顶级新闻源）**：
  ...
  - 覆盖范围：去重后约 **250 条**新闻，过滤后保留最近 2 天内
  - AI智能筛选两大优先领域：
    - **天体物理**：球状星团、白矮星、毫秒脉冲星、恒星演化、望远镜、星震学、中子星、X射线天文学、引力波、变星等
    - **心理学与神经科学**：元认知(metacognition)、fMRI、脑成像、认知神经科学、工作记忆、注意力、决策、成瘾等
  - 提供中英双语标题和 AI 生成的**倒金字塔结构**中文摘要（学术风格）
  - **新设计**：新闻链接采用简洁的 `🔗` 按钮 + 日期标注 + 来源标注
